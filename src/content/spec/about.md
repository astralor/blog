...
我是 **张昊辰**（Astralor），一个在 AI 基础设施与产品之间反复横跳的工程师。

从微服务到 OpenStack，从私有云到 Kubernetes，从智算集群到大模型推理训练——过去八年我一直在和"基础设施"打交道。2024 年起深入大模型内核研发，做过数据飞轮、推理优化、RAG 引擎。现在在探索 AI 写作产品方向，试着从"造轮子的人"变成"定义产品的人"。
